...
export const PracticeScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {__DEV__ && (
        <View style={styles.debugBanner} accessibilityLabel="Debug: correct word visible">
          <Text style={styles.debugBannerLabel}>Debug — solution</Text>
          <Text style={styles.debugBannerWord}>{solution.toUpperCase()}</Text>
        </View>
      )}
